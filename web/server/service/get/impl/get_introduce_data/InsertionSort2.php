...
class InsertionSort2 implements GetIntroduceDataAlgorithymInterface {
    public function getIntroduceData() :array
    {
        ...
        return [
            'intro' => 'Thuật toán InsertionSort2. Vui lòng nhập một mảng và số lượng các số trong mảng vào ô input',
            'data' => 'Ví dụ : Dòng đầu nhập số lượng ký tự : 7. Dòng 2 nhập mảng: 1 2 3 4 5 6 7',
